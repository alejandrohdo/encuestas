...
<head>
    ...
    <title>Sistema de encuestas para ingresantes | Pagina de registro</title>
...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>Sistema de encuestas </b>para ingresantes</a>
    </div>

    <div class="register-box-body">
        <p class="login-box-msg">Registrar nuevo</p>
